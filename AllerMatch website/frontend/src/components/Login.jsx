    ...
    loginUser(email, password)
      .then((response) => {
        if (response.isAuthenticated === true) {
          ...
          props.handleAccountStatus(response.accountStatus)
          history.push("/");
        }
      })
      .catch(() => {
      ...
      <div className="row">
        <form>
          ...
          <div class="row">
            <div className="col">
              <a
                className="waves-effect waves-light btn-small green darken-4"
                id="login"
                onClick={() => {
        ...
        <div className="col">
          <h5>No account?</h5>
          <Link to="/register">
            <a className="waves-effect waves-light btn-small green darken-4" id="login">
              Register here!
            </a>
          </Link>
        </div>
