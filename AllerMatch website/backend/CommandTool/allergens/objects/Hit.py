class Hit:
    ...
    def __init__(self, query_id: str, query_window: str, query_seq: str, query_length: int, query_start: int, query_end: int, hit_id: str, hit_seq: str, hit_length: int, hit_start: int, hit_end: int, 
                midline: str, alignment_string: str, formatted_alignment: str, bits: float, e_value: float, identity: float, similar: float, overlap: int, recalculated_ident: str):
        ...
        self.recalculated_ident = recalculated_ident
    ...
    def get_recalculated_ident(self):
        return self.recalculated_ident
    
    def set_recalculated_ident(self, value):
        self.recalculated_ident = value
    ...
    def to_dict(self):
        info = {
            ...
            "Recalc_ident": self.recalculated_ident
        }
        return info
